...
export async function openHelp () {
	...
	const {$dialog, resolver} = openDialog({
		$content: $dialog => render(html`
			...
			<h2>Coding Skills FAQ</h2>

			<h3>What is Coding Skills?</h3>
			<p>Coding Skills is a visual overview of useful skills to learn as a web developer. It is useful for people who just started learning about web development and for people who have been in the field for years and want to learn new things. As a beginner, I would encourage you not to see this website as the definitive list of what you need to know but as an example of what you can learn and where you can start. The skills are arranged in chronological order based on what learning path I recommend you to take but feel free to jump around freely.</p>
			...
			<p>I am spending my spare time building Coding Skills for free because I want to help people get into web development. My motivation comes from people finding Coding Skills useful, so if you like the project feel free to support me in any way you like! For example, you are more than welcome to become a <a target="_blank" href="https://github.com/alexandruarmas/coding/stargazers" rel="noopener" aria-label="Open become stargazer on Github">stargazer on Github</a>, share Coding Skills with your friends and followers or create blog articles linking to Coding Skills. If you want to, it will absolutely make my day if you <a href="https://www.buymeacoffee.com/alexandruarmas" target="_blank" aria-label="Buy coffee">support me with a cup of coffee</a>!</p>

			<h3>How can I get involved?</h3>
			<p>You are welcome to get involved in any way you like. If you want to, you can go to <a target="_blank" href="https://github.com/alexandruarmas/coding/issues" rel="noopener" aria-label="Open get involved">Github</a> and help me fix the spelling, fix issues or suggest some new features. Any involvement is highly appreciated!</p>
			...
			<p>The skills are based on what I personally find to be the most useful on a day-to-day basis. If you think something really important is missing, you can always suggest it on <a target="_blank" href="https://github.com/alexandruarmas/coding/issues" rel="noopener" aria-label="Open suggest feature">Github</a>.</p>
			...
			<p>When a skill is described as experimental, it means that the technology is immature and currently in the process of being added to the Web platform (or considered for addition). Think carefully before you start using experimental technology in any kind of production project. The definition used in Coding Skills is based on the excellent definition used on <a target="_blank" href="https://developer.mozilla.org/en-US/docs/MDN/Contribute/Guidelines/Conventions_definitions#Experimental" rel="noopener">MDN</a>. You are very welcome to open an issue on <a target="_blank" href="https://github.com/alexandruarmas/coding/issues" rel="noopener" aria-label="Open get involved">Github</a> if you see a skill you believe should be marked as "experimental" or have the banner removed.</p>
