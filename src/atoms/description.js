...
export class Description extends LitElement {
	...
	renderLink (link) {
		...
		return html`
			<div class="link">
				<img class="img" loading="lazy" width="16" height="16" intrinsicsize="16x16" src="https://www.google.com/s2/favicons?domain=${encodeURIComponent(getURLOrigin(url))}" alt="Logo for ${name}" />
