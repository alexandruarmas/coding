...
function logoForUrl (url) {
	return `<img style="margin-bottom: 0;" src="https://www.google.com/s2/favicons?domain=${encodeURIComponent(getURLOrigin(url))}" alt="Logo" />`;
}
...
writeFileSync(FILE_NAME, `<h1 align="center">Coding Skills</h1>
<p align="center">
